...
async def john_agent(ctx: agents.JobContext):
    ...
    await session.generate_reply(
        instructions="Greet the user warmly. Say: Hi there! I'm John Igbokwe - AI Architect and Software Developer based in Germany. I'd love to tell you about my experience and projects. I can speak with you in English or German. Which do you prefer?"
    )
